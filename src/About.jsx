function About() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <h2 className="text-4xl font-light text-stone-800 dark:text-stone-100 mb-8 tracking-tight">About</h2>
      ...
      <div className="space-y-8 text-stone-600 dark:text-stone-300 leading-relaxed">
        <div className="bg-stone-50 dark:bg-stone-800 p-8 rounded-sm border-l-4 border-emerald-700 dark:border-emerald-500">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-12">
          <div>
            <h3 className="text-2xl font-light text-stone-800 dark:text-stone-100 mb-4">Technical Focus</h3>
          ...
          <div>
            <h3 className="text-2xl font-light text-stone-800 dark:text-stone-100 mb-4">Beyond the Code</h3>
            <ul className="space-y-2 text-stone-600 dark:text-stone-300">
              <li className="flex items-start">
                <span className="text-emerald-700 dark:text-emerald-400 mr-2">▸</span>
        ...
        <div className="mt-12 p-8 bg-emerald-50 dark:bg-emerald-950/30 rounded-sm">
          <h3 className="text-2xl font-light text-stone-800 dark:text-stone-100 mb-4">Currently</h3>
